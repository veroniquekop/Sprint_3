...
class TestLocators:
    ...
    Search_button_personal_button_main_locator = (By.XPATH, "html/body/div/div/header/nav/a/p") #Войти в личный кабинет
    ...
    Logo_button_locator = (By.XPATH, ".// *[@id ='root']/div/header/nav/div/a/svg")  # Кнопка 'Логотип'
